...
fn talib_lookback(talib_name: &str) -> usize {
    ...
    let extra = match talib_name {
        ...
        | "CDLHIGHWAVE" | "CDLSPINNINGTOP" | "CDLLONGLINE" | "CDLSHORTLINE"
        | "CDLMARUBOZU" | "CDLCLOSINGMARUBOZU" | "CDLBELTHOLD" | "CDLRICKSHAWMAN"
        | "CDLTAKURI" => 0,
        // 2-bar patterns (need 1 extra bar for the pattern window + sometimes trailing for 1st bar)
        "CDLENGULFING" | "CDLHARAMI" | "CDLHARAMICROSS" | "CDLPIERCING"
        | "CDLDARKCLOUDCOVER" | "CDLDOJISTAR" | "CDLHAMMER" | "CDLHANGINGMAN"
        | "CDLINVERTEDHAMMER" | "CDLSHOOTINGSTAR" | "CDLHOMINGPIGEON"
        | "CDLINNECK" | "CDLONNECK" | "CDLTHRUSTING" | "CDLCOUNTERATTACK"
        | "CDLMATCHINGLOW" | "CDLKICKING" | "CDLKICKINGBYLENGTH"
        | "CDLSEPARATINGLINES" | "CDLGAPSIDESIDEWHITE" | "CDLSTICKSANDWICH" => 1,
        // 3-bar patterns
        "CDL3INSIDE" | "CDL3OUTSIDE" | "CDL3WHITESOLDIERS"
        | "CDL3LINESTRIKE" | "CDLEVENINGSTAR" | "CDLMORNINGSTAR"
        | "CDLEVENINGDOJISTAR" | "CDLMORNINGDOJISTAR" | "CDL2CROWS"
        | "CDLUPSIDEGAP2CROWS" | "CDLTRISTAR" | "CDLUNIQUE3RIVER"
        | "CDLIDENTICAL3CROWS" | "CDLADVANCEBLOCK" | "CDLSTALLEDPATTERN"
        | "CDLTASUKIGAP" | "CDLXSIDEGAP3METHODS" | "CDL3STARSINSOUTH" => 2,
        // 4-bar patterns (3 pattern bars + 1 prior bar)
        "CDL3BLACKCROWS" => 3,
        // 4-5 bar patterns
        "CDLCONCEALBABYSWALL" | "CDLLADDERBOTTOM" | "CDLRISEFALL3METHODS"
        | "CDLBREAKAWAY" | "CDLMATHOLD" => 4,
