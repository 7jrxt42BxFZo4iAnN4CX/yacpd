...
fn test_price_lines_bullish_positive() {
    ...
    let engine = EngineBuilder::new()
        .add(BuiltinDetector::PriceLines(
            PriceLinesDetector::with_defaults(),
        ))
        .build()
        .unwrap();
    let patterns = engine.scan(&bars).unwrap();
...
fn test_pattern_directions() {
    ...
    let engine = EngineBuilder::new()
        .add(BuiltinDetector::LongBlackDay(
            LongBlackDayDetector::with_defaults(),
        ))
        .build()
        .unwrap();
    let patterns = engine.scan(&bars).unwrap();
    ...
    let engine = EngineBuilder::new()
        .add(BuiltinDetector::LongWhiteDay(
            LongWhiteDayDetector::with_defaults(),
        ))
        .build()
        .unwrap();
    let patterns = engine.scan(&bars).unwrap();
